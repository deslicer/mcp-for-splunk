...
class EmbeddedResource(BaseResource):
    ...
    def _generate_content_hash(self, content: str) -> str:
        ...
        return hashlib.md5(content.encode("utf-8"), usedforsecurity=False).hexdigest()  # nosec B324
...
class EmbeddedResourceRegistry:
    ...
    def register_embedded_resource(self, resource: EmbeddedResource) -> None:
        ...
        try:
            ...
            pass  # Intentionally suppressed: back-reference is optional optimization
